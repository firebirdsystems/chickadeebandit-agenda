...
describe("manifest.json", () => {
  ...
  it("id is agenda",             () => expect(manifest.id).toBe("agenda"));
  ...
  it("declares family.members in data_access.reads", () => {
  ...
  it("has a medium widget", () => {
    expect(manifest.widget?.size).toBe("medium");
